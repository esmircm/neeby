...
<head>
    ...
    <?= Html::csrfMetaTags() ?>
    <title><?= Yii::t('easyii', 'Panel de Control') ?> - <?= Html::encode($this->title) ?></title>
    ...
    <div >
        <div class="wrapper">
            <div class="header">
                ...
                <div class="nav">
                    <a href="<?= Url::to(['/']) ?>" class="pull-left"><i class="glyphicon glyphicon-home"></i> <?= Yii::t('easyii', 'Abrir Sitio') ?></a>
                    <a href="<?= Url::to(['/admin/sign/out']) ?>" class="pull-right"><i class="glyphicon glyphicon-log-out"></i> <?= Yii::t('easyii', 'Cerrar Sesión') ?></a>
                </div>
            </div>
            <div class="main">
